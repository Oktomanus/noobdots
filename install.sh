...
install_packages() {
  ...
  TERMINAL_PACKAGES="yazi foot fastfetch fish tmux rust btop bat rg fd battop brightnessctl git openssh helix paru duf fzf eza zoxide calcurse impala p7zip ntfs-3g qalculate-gtk cava lolcat"
