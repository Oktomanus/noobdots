...
install_packages() {
  ...
  TERMINAL_PACKAGES="yazi foot fastfetch fish rust btop battop brightnessctl git openssh helix paru duf fzf eza zoxide calcurse impala p7zip ntfs-3g qalculate-gtk cava lolcat"
